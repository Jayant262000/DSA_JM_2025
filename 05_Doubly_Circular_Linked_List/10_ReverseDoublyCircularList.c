/*
  ...
  write a c program to to Reverse the circular Doubly linked list.
...
void DisplayReverseLinkedList(DCLL * );
...
//Display Reverse Doubly Circular Linked list
void DisplayReverseLinkedList(DCLL * last){
	int flag = 0;
...
int main(void){
	...
	do{
		...
		printf("Enter 3: to Display Reverse Doubly Linked List\n");	
