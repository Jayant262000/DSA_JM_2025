/*
    Wrtie a C program to create BST and Search an element in BST using Recursion
*/
...
int SearchNode(BST * Root,int key)
{
    if(Root!=NULL)
    {
        if(Root->data  == key)
...
int main()
{
    ...
    {
        printf("\n ***** Node with Key %d is found in the BST *** \n",key);
    }
    else
    {
         printf("\n !!! Node with Key %d is not found in the BST !!!\n",key);
    }
